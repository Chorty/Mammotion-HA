...
Ported from mikey0000/Mammotion-HA commit f4428d47 -- the module under test
is pure logic (no Home Assistant or pymammotion imports), so these run with
no hass fixture.
"""

from __future__ import annotations

from custom_components.mammotion.connectivity import (
    RECONNECT_COOLDOWN_SECS,
    CloudConnectivityMonitor,
    WatchdogAction,
)

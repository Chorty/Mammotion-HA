...
WORK_SENSOR_TYPES: tuple[MammotionWorkSensorEntityDescription, ...] = (
    ...
    MammotionWorkSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        native_unit_of_measurement=None,
        value_fn=lambda coordinator, mower_data: len(mower_data.map.plan),
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    MammotionWorkSensorEntityDescription(
        key="enabled_task_count",
        state_class=SensorStateClass.MEASUREMENT,
        native_unit_of_measurement=None,
        value_fn=lambda coordinator, mower_data: sum(
            1 for plan in mower_data.map.plan.values() if plan.is_enabled()
        ),
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    MammotionWorkSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        native_unit_of_measurement=None,
        value_fn=lambda coordinator, mower_data: len(mower_data.map.area),
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    MammotionWorkSensorEntityDescription(
        key="map_area_name_count",
        state_class=SensorStateClass.MEASUREMENT,
        native_unit_of_measurement=None,
        value_fn=lambda coordinator, mower_data: len(mower_data.map.area_name),
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    MammotionWorkSensorEntityDescription(
        key="last_map_sync",
        ...
        device_class=SensorDeviceClass.TIMESTAMP,
        native_unit_of_measurement=None,
        value_fn=lambda coordinator, mower_data: coordinator.last_map_sync,
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    MammotionWorkSensorEntityDescription(
        key="last_task_sync",
        ...
        device_class=SensorDeviceClass.TIMESTAMP,
        native_unit_of_measurement=None,
        value_fn=lambda coordinator, mower_data: coordinator.last_task_sync,
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    MammotionWorkSensorEntityDescription(
        key="last_map_task_error",
        state_class=None,
        native_unit_of_measurement=None,
        value_fn=lambda coordinator, mower_data: coordinator.last_map_task_error,
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    MammotionWorkSensorEntityDescription(
